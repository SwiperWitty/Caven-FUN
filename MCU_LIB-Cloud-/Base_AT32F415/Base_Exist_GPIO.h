...
//User io
#define User_EN_SPK	GPIO_PINS_11 	//PA11
#define User_IO3	GPIO_PINS_2		//PD2 

#define User_IO3_R() gpio_input_data_bit_read(GPIOD,GPIO_PINS_2)  
#define User_EN_SPK_L() GPIOA->clr = User_IO3
#define User_EN_SPK_H() GPIOA->scr = User_IO3
...
#ifdef Exist_LED
    #define LED_L() GPIOA->clr = GPIO_PINS_12       //LED
    #define LED_H() GPIOA->scr = GPIO_PINS_12      //PA12
